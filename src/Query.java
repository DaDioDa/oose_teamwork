...
public class Query {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            rs = st.executeQuery("select * from sauce");// 下達 SQL 命令
            System.out.printf("%s\t", "----------配醬----------");
            System.out.printf("\n");
            ...
            rs = st.executeQuery("select * from soup");// 下達 SQL 命令
            System.out.printf("%s\t", "----------湯品----------");
            System.out.printf("\n");
            while (rs.next()) {
                System.out.printf("%s\t", rs.getString("name"));
                System.out.printf("%s\t", rs.getInt("price"));
            ...
            rs = st.executeQuery("select * from dessert");// 下達 SQL 命令
            System.out.printf("%s\t", "----------點心----------");
            System.out.printf("\n");
            while (rs.next()) {
                System.out.printf("%s\t", rs.getString("name"));
                System.out.printf("%s\t", rs.getInt("price"));
            ...
            rs = st.executeQuery("select * from drinks");// 下達 SQL 命令
            System.out.printf("%s\t", "----------飲料----------");
            System.out.printf("\n");
            while (rs.next()) {
                System.out.printf("%s\t", rs.getString("name"));
                System.out.printf("%s\t", rs.getInt("price"));
